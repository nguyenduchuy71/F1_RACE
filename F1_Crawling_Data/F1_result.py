...
# crawl_race_result(driver, RACE_RESULT_HEADER, 1960, 2023)
# crawl_driver_result(driver, DRIVER_RESULT_HEADER, 1960, 2023)
# crawl_team_result(driver, TEAM_RESULT_HEADER, 1960, 2023)
